...
CACHE_FILE = DRIVE_DIR / "predictions_cache_32b_finetune_run10.json" # the cache of the run 
EVAL_LOG_FILE = DRIVE_DIR / "comprehensive_eval_log_32b_finetune_run10.json" # The master (final) record of the whole run

# Hardware tracking setup
HARDWARE_LOG_FILE = DRIVE_DIR / "hardware_usage_32b_finetune_run9.csv"
