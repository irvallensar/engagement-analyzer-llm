...
from scripts.data_loader import load_iob_dataset, extract_spans_from_iob
from scripts.local_llm_client import call_local_llm
from collections import defaultdict

# ==========================================
# PROMPT 1: THE LIBRARIAN (Structure & References)
# Focus: Citation, Attribution, Sources, Endophoric
# ==========================================
...
# ==========================================
# PROMPT 2: THE CRITIC (Stance & Rhetoric)
# Focus: Monogloss, Deny, Counter, Proclaim, Entertain, Justifying
# ==========================================
...
def evaluate_dataset(file_path, max_samples=None):
    ...
    sentences, true_labels = load_iob_dataset(file_path)
    ...
    for i, sentence in enumerate(tqdm(sentences, desc="Evaluating")):
        ...
        # Extract Gold Spans
        gold_spans = extract_spans_from_iob(sentence) # {(Label, Start, End), ...}
        ...
        for p in merged_preds:
            ...
            # Simple substring matching for alignment
        ...
        # For category breakdown, we check matches per label type
...
if __name__ == "__main__":
    # RUN ON FULL DATASET (Or change 100 to None)
