...
CACHE_FILE = DRIVE_DIR / "predictions_cache_3_32b.json" # the cache of the run (containing the logs such as predicted spans 
                                                  # from the LLM, data saved)
EVAL_LOG_FILE = DRIVE_DIR / "comprehensive_eval_log_3_32b.json" # The master (final) record of the whole run
