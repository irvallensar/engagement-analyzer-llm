...
# 1. Define the Strict Pydantic Schema (string based/text based)
...
def call_local_llm(prompt_text):
    ...
    if generator is None:
        print("\n[SYSTEM] Loading Mistral-Small-3.2-24B-Instruct-2506-4bit into memory...")
        model_id = "mlx-community/Mistral-Small-3.2-24B-Instruct-2506-4bit"
